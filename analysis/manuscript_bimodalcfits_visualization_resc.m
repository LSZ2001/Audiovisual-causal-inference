        ...
        if(plot_individual)
            ...
            for idx=1:(num_subjects+1)
                ...
                if(idx==16)
                    ...
                    lg = legend("Center, Visual (high reliability)","Periphery, Visual (high reliability)","Center, Visual (med reliability)", "Periphery, Visual (med reliability)", "Center, Visual (low reliability)", "Periphery, Visual (low reliability)");
                    set(lg,'Box','off')
                end
                xlim([-30,30])
                ylim([0,1])
